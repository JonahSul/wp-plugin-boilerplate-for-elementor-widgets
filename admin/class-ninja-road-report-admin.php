 ...
 * @subpackage Ninja_Road_Report/admin
 */
...
class Ninja_Road_Report_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $Ninja_Road_Report       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->Ninja_Road_Report, plugin_dir_url( __FILE__ ) . 'css/ninja-road-report-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->Ninja_Road_Report, plugin_dir_url( __FILE__ ) . 'js/ninja-road-report-admin.js', array( 'jquery' ), $this->version, false );
